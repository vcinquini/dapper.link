...
namespace Dapper
{
    ...
    public interface IDbQuery<T>
    {
        ...
        /// <summary>
        /// Asynchronously retrieve data by primary key
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// update query, update according to Primarkey by default, if there is where, only use the specified update condition,
